              ...
              <div key={index} className="relative pl-6 sm:pl-8">
                ...
                <div className="card-clean p-5 sm:p-6 rounded-xl group">
                  ...
                  {exp.highlights && exp.highlights.length > 0 && (
                    <div className="space-y-1.5 pt-3 border-t border-slate-100 dark:border-slate-800 mb-3">
                  ...
                  {exp.skills && exp.skills.length > 0 && (
                    <div className="flex flex-wrap gap-1.5 pt-2">
                      {exp.skills.map((skill, sIdx) => (
                        <span 
                          key={sIdx}
                          className="px-2 py-0.5 rounded-md bg-slate-100 dark:bg-slate-800 text-[10px] font-mono font-medium text-slate-600 dark:text-slate-300"
                        >
                          {skill}
                        </span>
                      ))}
